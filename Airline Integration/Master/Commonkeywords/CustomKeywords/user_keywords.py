...
def random_name():
    try:
        random_string = fake.first_name().lower()
...
def generate_passport_number():
    # Format: 1 uppercase letter followed by 6 digits (e.g., A123456)
    letter = random.choice(string.ascii_uppercase)
    digits = ''.join(random.choices(string.digits, k=6))

    passport_number = f"{letter}{digits}"
...
@keyword
def append_booking_id_to_excel(file_name, From=None, To=None, Adults=None, Childrens=None, Infants=None, Booking_Id=None, Pax_Label=None, Connectivity=None):
    print(">>>>>")
    print(file_name)
...
def generate_passport_number1():
    ...
    # Combine them to form the passport number
    passport_number = first_letter + digits
    return passport_number


@keyword
def extract_booking_id(input_str):
    # Split the string and return the last part
    parts = input_str.split()
    return parts[-1] if parts else None

# Example usage
# input_str = "Booking ID TJS118000106458"
# result = extract_booking_id(input_str)
# print(result)  # Output: TJS118000106458